package Serialization.payload.utils;
...
public class DataReader {
	...
	public static String[][] readCsvData(String csvFileName) {
		...
		String[][] data = null;
		try {
			reader = new CSVReaderBuilder(new java.io.FileReader("src/main/resources/data/" + csvFileName + ".csv")).withSkipLines(1).build();
	...
	public static void main(String[] args) {
		try {
			CSVReader reader = new CSVReaderBuilder(new java.io.FileReader("src/main/resources/data/incidents.csv")).withSkipLines(1).build();
